...
export default function EditExerciseModal({editingExercise, setEditingExercise, workout}: EditExerciseModalProps) {
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 border-gray-800 z-1">
                    ...
                    <ul>
                        ...
                        <li key={index} className="border bg-white border-gray-300 rounded-md p-4 mt-4 shadow-lg transform transition-transform hover:scale-105 flex flex-row justify-between">
                            ...
                            <button onClick={() => setExercises(exercises.filter((current_exercise: Exercise) => exercise.exercise_id != current_exercise.exercise_id))} className="bg-red-400 text-white rounded-md py-1 px-2 cursor-pointer font-semibold mt-2 text-sm">
                                Remove
                            </button>
                        </li>
                        ))}
