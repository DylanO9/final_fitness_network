    ...
    return (
        ...
        <div className="w-full h-full">
                ...
                <div className="flex h-3/4">
                    ...
                    <div className="w-1/4 bg-white shadow-md rounded-lg p-4 overflow-y-auto">
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-4 bg-gray-100 shadow-md rounded-full p-4">
                                <img
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Last message: "Hello, how are you?"</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 bg-gray-100 shadow-md rounded-lg p-4">
                                ...
                                />
                                <div>
                                    <h2 className="text-xl font-semibold">Friend 2</h2>
                                    <p className="text-gray-600">Last message: "Are we still on for tomorrow?"</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 bg-gray-100 shadow-md rounded-lg p-4">
                                <img
                                ...
                                />
                                <div>
                                    <h2 className="text-xl font-semibold">Friend 3</h2>
                                    <p className="text-gray-600">Last message: "Don't forget the meeting!"</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-3/4 flex flex-col ml-4 bg-white shadow-md rounded-lg p-4">
