...
export default function Exercises() {
    ...
    return (
        <div className="w-full">
            ...
            <form className="w-lg bg-white mx-auto flex items-center flex-col p-4 border border-gray-300" onSubmit={(e) => {handleCreateExercise(e)}}>
            ...
            <button type="submit" className="bg-purple-400 text-white rounded-md py-2 px-4 cursor-pointer font-semibold">Add</button>
            </form>
            ...
            <table className="table-auto w-full mt-10 border-collapse border border-gray-300">
                ...
                {exercises.map((exercise, index) => (
                    ...
                    <td className="border border-gray-300 px-4 py-2">-</td> {/* Placeholder for sets */}
                    <td className="border border-gray-300 px-4 py-2">-</td> {/* Placeholder for reps */}
            ...
            <p className="mt-4">No exercises found.</p>
            )}
        </div>
    )
}